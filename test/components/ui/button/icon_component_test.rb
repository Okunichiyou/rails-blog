...
class Ui::Button::IconComponentTest < ViewComponent::TestCase
  # =====================================
  # #html属性
  # =====================================
  test "デフォルトの属性が設定され、渡したカテゴリ/テキストが反映されること" do
    render_inline(Ui::Button::IconComponent.new(category: :secondary, size: :medium, text: "test"))
  ...
  test "渡したdisabledが反映されること" do
    render_inline(Ui::Button::IconComponent.new(category: :secondary, size: :medium, text: "test", disabled: true))

    assert_selector("button[disabled]", text: "test")
  end

  test "渡したクラスが反映されること" do
    render_inline(Ui::Button::IconComponent.new(category: :secondary, size: :medium, text: "test", class: "added added2"))
  ...
  test "アイコンなしで正常にレンダリングされること" do
    render_inline(Ui::Button::IconComponent.new(category: :primary, size: :medium, text: "test"))
  ...
  test "アイコンを左側に配置できること" do
    ...
    render_inline(Ui::Button::IconComponent.new(
      category: :secondary,
      size: :medium,
      text: "test",
      icon: icon_html,
  ...
  test "size: :fullでw-fullクラスが適用されること" do
    render_inline(Ui::Button::IconComponent.new(category: :primary, size: :full, text: "test"))

    assert_selector("button.w-full")
  end

  test "size: :largeで正しいクラスが適用されること" do
    render_inline(Ui::Button::IconComponent.new(category: :primary, size: :large, text: "test"))
  ...
  test "size: :smallで正しいクラスが適用されること" do
    render_inline(Ui::Button::IconComponent.new(category: :primary, size: :small, text: "test"))
