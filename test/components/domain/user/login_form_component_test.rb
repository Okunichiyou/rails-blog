...
class Domain::User::LoginFormComponentTest < ViewComponent::TestCase
  test "flashがある場合、flashを表示していること" do
    ...
    component = Domain::User::LoginFormComponent.new(resource: database_auth, resource_name: :user_database_authentication, session_path: "/users/sign_in")
  ...
  test "database-authentication-formの要素があること" do
    ...
    render_inline(Domain::User::LoginFormComponent.new(resource: database_auth, resource_name: :user_database_authentication, session_path: "/users/sign_in"))
